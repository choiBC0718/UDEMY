...
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnTeamInfluencerCountUpdateDelegate, int /*Team1InfluencerCount*/, int /*Team2InfluencerCount*/);
UCLASS()
...
public:
	...
	FOnTeamInfluencerCountUpdateDelegate OnTeamInfluencerCountUpdate;
